...
include("modellers/MCMCGibbsModel.jl")
...
include("samplers/Gibbs.jl")  # generic Gibbs sampler
...
# no diag
GibbsChain(r::Range{Int}, s::Dict{Symbol, Array},
           t::Union(MCMCTask, Array{MCMCTask}), rt::Float64) =
  GibbsChain(r, s, Dict(), t, rt)

GibbsChain(r::Range{Int}, s::Dict{Symbol, Array},
           d::Dict, t::Union(MCMCTask, Array{MCMCTask})) =
  GibbsChain(r, s, d, t, NaN)
...
include("runners/SerialGibbs.jl")  # generic Gibbs runner
